...
public class Viewer extends CustomComponent {
			...
			docs_table.addValueChangeListener(new Property.ValueChangeListener() {
				...
				public void valueChange(
					...
					embedded_1.setSource(new ExternalResource(
							Nanotate_Properties.getInstance().getProperty("host")+"/repository/"+uuid+"/index.html#username="+getSession().getAttribute("user")));
				}
			});
	...
	private Panel buildDocs() {
		...
		docs_label =  new Label("Documents");
		docs_label.setStyleName("docs-label");
...
//		absoluteLayout_2.addComponent(docs_label, "top:0.0px;right:0.0;bottom:0.0px;");
