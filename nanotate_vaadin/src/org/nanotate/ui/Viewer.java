...
public class Viewer extends CustomComponent {
	...
	private ArrayList<AnnotationWithBLOBs> annotations_data;
	private Label docs_label;
	private AnnotationDaemon annotationDaemon;
		...
		try {
			...
			docs_table.addValueChangeListener(new Property.ValueChangeListener() {
				...
				public void valueChange(
					...
					if(stoped)
						{
							annotationDaemon=new AnnotationDaemon();	
							Thread annotationDaemonThread = new Thread(annotationDaemon);
							annotationDaemonThread.start();
							stoped=false;
						}
					else
					{
						annotationDaemon.stop();
						annotationDaemon=new AnnotationDaemon();
						Thread annotationDaemonThread = new Thread(annotationDaemon);
						annotationDaemonThread.start();			
					}
	...
	private void loadAnnotations(String doi, String user){
		...
		annotations_data =  AnnotationUtils.getAnnotations(doi, user);


		for(AnnotationWithBLOBs annotation :  annotations_data){
